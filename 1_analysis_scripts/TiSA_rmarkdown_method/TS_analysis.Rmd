---
title: "TimeSeries Analysis – COVID Mock vs Infected"
author: "Yohan Lefol"
...
my_path_data<-'raw_counts_TS'
my_path_sample_dta<-'sample_file.csv'
...
PART_l2fc<-5 #log(2)foldChange threshold for PART clustering
